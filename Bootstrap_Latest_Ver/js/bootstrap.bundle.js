...
(function (global, factory) {
  ...
  const typeCheckConfig = (componentName, config, configTypes) => {
    Object.keys(configTypes).forEach(property => {
      ...
      // }
      const expectedTypesPattern = new RegExp(
        "^(" + expectedTypes.join("|") + ")$"
      );
      if (!expectedTypesPattern.test(valueType)) {
        throw new TypeError(
    ...
    static jQueryInterface(config) {
      return this.each(function () {
        ...
        const functionWhitelist = {
          close: functionToClose
        };
        if (functionWhitelist.hasOwnProperty(config)) {
        functionWhitelist[config](this);
        }
