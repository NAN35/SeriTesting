<%@ page title="" language="C#" masterpagefile="~/Report/MajorAssetMymaster.master" autoeventwireup="true" inherits="Format_F6, App_Web_format_f6.aspx.1933d7c" viewStateEncryptionMode="Always" %>
            ...
            <div>
                 ...
                 <fieldset id="fieldset3" runat="server" align="center" style="border: solid 2px #9999FF;
                    ...
                    <legend><span class="style2" style="color:#05013e; font-weight: bold; font-size: 20px">
                        <b>ಕೃಷಿ ಕ್ಷೇತ್ರದ ದೈನಂದಿನ ಕಾರ್ಯಚಟುವಟಿಕೆಗಳ ವಿವರ</b></span> </legend>
