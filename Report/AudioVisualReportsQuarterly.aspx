<%@ page title="" language="C#" masterpagefile="~/Report/MajorAssetMymaster.master" autoeventwireup="true" inherits="AudioVisualReportsQuarterly, App_Web_audiovisualreportsquarterly.aspx.1933d7c" viewStateEncryptionMode="Always" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
   ...
   <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            ...
            <div>
                  ...
                  <fieldset id="fieldset3" runat="server" align="center" style="border: solid 2px #E0EEE0;
                    margin: 5px; padding: 10px; background-color: #F7F7F7">
                    <legend><span class="style2" style="color: #008B8B; font-weight: bold; font-size: 20px">
                        <b>Audio Visual Reports Quarterly</b></span> </legend>
