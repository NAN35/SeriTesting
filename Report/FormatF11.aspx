<%@ page title="" language="C#" masterpagefile="~/Report/MajorAssetMymaster.master" autoeventwireup="true" inherits="FormatF11, App_Web_formatf11.aspx.1933d7c" viewStateEncryptionMode="Always" %>
   ...
   <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            ...
            <div>
                 ...
                 <div class="form-group col-md-12" runat="server">
                       ...
                       <div class="col-lg-4">
                              <label class="control-label col-sm-4" for="txtappliaadhar"> Month</label>
                             <div class="col-sm-8">
                            <asp:DropDownList ID="ddlmonth" CssClass="form-control" AutoPostBack="true" runat="server"  >
                ...
                <asp:ListItem Value="12">DECEMBER</asp:ListItem>
                       ...
                       <div class="col-lg-4">
                        ...
                        Grainage Name</label>
                         <div class="col-sm-7">
                             <asp:DropDownList ID="ddscheme" CssClass="form-control" AutoPostBack="true" runat="server">
                             </asp:DropDownList>
                         </div>
                     </div>
                      ...
                      <div class="form-group col-md-12" runat="server">
                        ...
                        <div class="col-lg-4">
                                <label class="col-lg-4">
                                    From:</label>
                                <div class="col-lg-8">
                                    <asp:Image ID="ImageCalender1" runat="server" AlternateText="" ImageUrl="~/images/CALENDERIMAGE.jpg"
                                        Style="height: 18px; display: inline-block;" />
                                    <asp:TextBox ID="txtfromdate" runat="server" MaxLength="10" AutoPostBack="true" onkeypress="return validateAddress(event)"
                                         class="form-control" Style="width:85%; display: inline-block;"
                                        placeholder="dd/mm/yyyy"></asp:TextBox>
                                    <asp:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" PopupButtonID="ImageCalender1"
                        ...
                        <div class="col-lg-4">
                                <label class="col-lg-3">
                                    TO:</label>
                                <div class="col-lg-9">
                                    <asp:Image ID="ImageCalender2" runat="server" AlternateText="" ImageUrl="~/images/CALENDERIMAGE.jpg"
                                        Style="height: 18px; display: inline-block;" />
                                    <asp:TextBox ID="txttodate" runat="server" MaxLength="10" AutoPostBack="true" onkeypress="return validateAddress(event)"
                                         class="form-control" Style="width:85%; display: inline-block;"
                                        placeholder="dd/mm/yyyy"></asp:TextBox>
                                    <asp:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy" PopupButtonID="ImageCalender2"
                                        TargetControlID="txttodate">
                                    </asp:CalendarExtender>
                                </div>
                            </div>
                            <div class="col-lg-3">
                              <label class="control-label col-sm-4" for="txtappliaadhar"> Week</label>
                             <div class="col-sm-8">
                            <asp:DropDownList ID="ddlweeklist" CssClass="form-control" AutoPostBack="true" runat="server"  >
                ...
                <asp:ListItem Value="3">4th Week</asp:ListItem>
                                 </asp:DropDownList>
                        </div>
                            </div>
