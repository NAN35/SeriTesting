<%@ page title="" language="C#" masterpagefile="~/Report/MajorAssetMymaster.master" autoeventwireup="true" inherits="MSG24, App_Web_msg24.aspx.1933d7c" viewStateEncryptionMode="Always" %>
            ...
            <div>
                 ...
                 <fieldset id="fieldset3" runat="server" align="center" style="border: solid 2px #9999FF;
                    ...
                    <legend><span class="style2" style="color:#05013e; font-weight: bold; font-size: 20px">
                        <b>ಸರ್ಕಾರಿ ಪಿ1 ಬಿತ್ತನೆಕೋಠಿ ಯಲ್ಲಿ  ಮಾಹೆಯಲ್ಲಿ ತಂಡವಾರು ಮೊಟ್ಟೆಗಳ ಉತ್ಪಾದನಾ ವರದಿ
</b></span> </legend>
