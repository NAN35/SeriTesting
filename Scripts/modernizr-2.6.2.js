...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /*jshint evil:true */
      ...
      function addStyleSheet(ownerDocument, cssText) {
        ...
        // Code with user controlled data sanitized to prevent XSS vulnerability
      ...
      return parent.insertBefore(textNode, parent.firstChild);
