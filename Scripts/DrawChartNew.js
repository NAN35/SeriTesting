...
function bargrapgh() {
    ...
    var all = document.getElementById("lblallcoation").innerHTML;
    var rel = document.getElementById("lblrelease").innerHTML;
    var exp = document.getElementById("lblexpenditure").innerHTML
